...
import com.example.navigationbar.databinding.ActivityQuiz6Binding

//stage4 퀴즈 액티비티 화면
class Quiz6 : AppCompatActivity(), View.OnClickListener {
    private lateinit var binding:ActivityQuiz6Binding
    //현재 질문 위치를 나타내는 변수
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityQuiz6Binding.inflate(layoutInflater)
        setContentView(binding.root)
        //QuizData4에 있는 문제들을 questionList에 가져옴
        questionList = QuizData4.getQuestion()
        //화면 셋팅
        getQuestionData()
        ...
        binding.btnSubmit.setOnClickListener {
            ...
            if (currentPosition <= questionList.size) {
                ...
                val intent = Intent(this@Quiz6, Quiz8::class.java)
