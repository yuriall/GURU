...
import com.example.navigationbar.databinding.ActivityQuiz7Binding

//stage5 퀴즈 액티비티 화면
class Quiz7 : AppCompatActivity(), View.OnClickListener {
    private lateinit var binding:ActivityQuiz7Binding
    //현재 질문 위치를 나타내는 변수
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //QuizData5에 있는 문제들을 questionList에 가져옴
        ...
        binding.btnSubmit.setOnClickListener {
            ...
            if (currentPosition <= questionList.size) {
                ...
                val intent = Intent(this@Quiz7, Quiz8::class.java)
